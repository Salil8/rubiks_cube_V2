//
// Created by salil on 23-06-2024.
//
...
int main()
{
 ...
 // Unordered_map of Cubes  ------------------------------------------------------------------------------------
   ...
   // else cout << "Cube2 is not present\n";
    ...
    //sample to compare all solvers copy and paste this within the solver codes
    // vector<RubiksCube::MOVE> shuffle_moves = {
    //     RubiksCube::MOVE::R, RubiksCube::MOVE::D, RubiksCube::MOVE::F,
    //     RubiksCube::MOVE::L2, RubiksCube::MOVE::DPRIME,
    //     RubiksCube::MOVE::F2,RubiksCube::MOVE::R
    // };
    // for(auto move: shuffle_moves) cube.move(move);
    ...
    // cube.print();
    //
    // DFSSolver<RubiksCube3dArray, Hash3d> dfsSolver(cube, 9);
    ...
    //string fileName = "C:\\Users\\user\\CLionProjects\\rubiks-cube-V2\\Databases\\cornerDepth5V1.txt";
    string fileName="C:\\Users\\salil\\OneDrive\\Desktop\\CLionProjects\\rubiks-cube-V2\\Databases\\cornerDepth5V1.txt";
